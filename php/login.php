...
$sql = "SELECT * FROM nov_mem WHERE NOV_mem_id='{$login_id}'";
...
if(!$id_match){
  echo "
    <script>
      ...
      location.href='/renewal-novella/pages/join_form.php';
    </script>
  ";
} else {
  //테이블 데이터 값을 배열로 저장
  ...
  //비밀번호 문자열 추출하여 저장
  $db_pass = $login_row['NOV_mem_pass'];
  ...
  ";
    ...
    session_start();
    $_SESSION['userid'] = $login_row['NOV_mem_id'];
