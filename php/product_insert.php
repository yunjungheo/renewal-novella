...
$pro_size = $_POST['pro_insert_size'];
...
$pro_upload_dir = $_SERVER['DOCUMENT_ROOT']."/renewal-novella/data/product_imgs/";
...
location.href='/renewal-novella/pages/admin/product_imgs'
